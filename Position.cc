...
inline Position::Position() : Vector() 
{
  //This method intentionally left blank.
} //Position default constructor

inline Position::Position(Vector vec) : Vector(vec[0],vec[1],vec[2]) 
{
  //This method intentionally left blank.
} //Position constructor from Vector

inline Position::Position(double longitude, double latitude, double altitude) {
...
inline Position::Position(double theta_inp, double phi_inp) : Vector(theta_inp,phi_inp) 
{
  //This method intentionally left blank.
} //Constructor Position(theta,phi)

inline double Position::Distance(const Position &second) const {
...
inline double Position::SurfaceDistance(const Position &second, double local_surface) const {
